...
subject to secondsivit:
  sum{p in P}x[6205, 1, p] == 1;

subject to thirdvisit:
  sum{p in P}x[8236, 2, p] == 1;

subject to fourthvisit:
  sum{p in P}x[1592, 3, p] == 1;

subject to fifthvisit:
  sum{p in P}x[1813, 4, p] == 1;

subject to sixthvisit:
  sum{p in P}x[15728, 5, p] == 1;

subject to seventhvisit:
  sum{p in P}x[14140, 6, p] == 1;

subject to eighthvisit:
  sum{p in P}x[8643, 7, p] == 1;

subject to ninthvisit:
  sum{p in P}x[8169, 8, p] == 1;

subject to tenthvisit:
  sum{p in P}x[6686, 9, p] == 1;

subject to eleventhvisit:
  sum{p in P}x[11087, 10, p] == 1;

subject to twelfthvisit:
  sum{p in P}x[10635, 11, p] == 1;
