...
subject to secondvisit5:
  x[6205, 1, 5] == 1;

subject to thirdvisit5:
  x[6686, 2, 5] == 1;

subject to fourthvisit5:
  x[8169, 3, 5] == 1;

subject to secondvisit6:
  x[8236, 1, 6] == 1;

subject to thirdvisit6:
  x[8643, 2, 6] == 1;

subject to fourthvisit6:
  x[13107, 3, 6] == 1;
